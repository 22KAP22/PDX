...
def get_pq8_index_filename(file, norm=True, balanced=False):
    if balanced:
        return f"ivf_pq8_{file}_norm.index.balanced"
    if norm:
        return f"ivf_pq8_{file}_norm.index"
    return f"ivf_pq8_{file}.index"
