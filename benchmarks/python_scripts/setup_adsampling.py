...
if __name__ == "__main__":
    ...
    # generate_adsampling_ivf2('coco-nomic-768-normalized', normalize=True)
    # generate_adsampling_ivf2('simplewiki-openai-3072-normalized', normalize=True)
    # generate_adsampling_ivf2('imagenet-align-640-normalized', normalize=True)
    # generate_adsampling_ivf2('imagenet-clip-512-normalized', normalize=True)
    # generate_adsampling_ivf2('laion-clip-512-normalized', normalize=True)
    # generate_adsampling_ivf2('codesearchnet-jina-768-cosine', normalize=True)
    # generate_adsampling_ivf2('yi-128-ip', normalize=True)
    # generate_adsampling_ivf2('landmark-dino-768-cosine', normalize=True)
    # generate_adsampling_ivf2('landmark-nomic-768-normalized', normalize=True)
    # generate_adsampling_ivf2('arxiv-nomic-768-normalized', normalize=True)
    # generate_adsampling_ivf2('ccnews-nomic-768-normalized', normalize=True)
    # generate_adsampling_ivf2('celeba-resnet-2048-cosine', normalize=True)
    # generate_adsampling_ivf2('llama-128-ip', normalize=True)
    # generate_adsampling_ivf2('yandex-200-cosine', normalize=True)
    # generate_adsampling_ivf2('word2vec-300', normalize=True)
    # generate_adsampling_ivf2('sift-128-euclidean', normalize=True)
    # generate_adsampling_ivf2('openai-1536-angular', normalize=True)
    # generate_adsampling_ivf2('msong-420', normalize=True)
    # generate_adsampling_ivf2('instructorxl-arxiv-768', normalize=True)
    # generate_adsampling_ivf2('contriever-768', normalize=True)
    # generate_adsampling_ivf2('gist-960-euclidean', normalize=True)
    # generate_adsampling_ivf2('yahoo-minilm-384-normalized', normalize=True)
    # generate_adsampling_ivf2('gooaq-distilroberta-768-normalized', normalize=True)
    # generate_adsampling_ivf2('agnews-mxbai-1024-euclidean', normalize=True)
    # generate_adsampling_ivf2('glove-200-angular', normalize=True)
    #
    # generate_adsampling_ivf2_global8('coco-nomic-768-normalized', normalize=True)
    # generate_adsampling_ivf2_global8('simplewiki-openai-3072-normalized', normalize=True)
    # generate_adsampling_ivf2_global8('imagenet-align-640-normalized', normalize=True)
    # generate_adsampling_ivf2_global8('imagenet-clip-512-normalized', normalize=True)
    # generate_adsampling_ivf2_global8('laion-clip-512-normalized', normalize=True)
    # generate_adsampling_ivf2_global8('codesearchnet-jina-768-cosine', normalize=True)
    # generate_adsampling_ivf2_global8('yi-128-ip', normalize=True)
    # generate_adsampling_ivf2_global8('landmark-dino-768-cosine', normalize=True)
    # generate_adsampling_ivf2_global8('landmark-nomic-768-normalized', normalize=True)
    # generate_adsampling_ivf2_global8('arxiv-nomic-768-normalized', normalize=True)
    generate_adsampling_ivf2_global8('ccnews-nomic-768-normalized', normalize=True)
    # generate_adsampling_ivf2_global8('celeba-resnet-2048-cosine', normalize=True)
    # generate_adsampling_ivf2_global8('llama-128-ip', normalize=True)
    # generate_adsampling_ivf2_global8('yandex-200-cosine', normalize=True)
    # generate_adsampling_ivf2_global8('word2vec-300', normalize=True)
    # generate_adsampling_ivf2_global8('sift-128-euclidean', normalize=True)
    # generate_adsampling_ivf2_global8('openai-1536-angular', normalize=True)
    # generate_adsampling_ivf2_global8('msong-420', normalize=True)
    # generate_adsampling_ivf2_global8('instructorxl-arxiv-768', normalize=True)
    # generate_adsampling_ivf2_global8('contriever-768', normalize=True)
    # generate_adsampling_ivf2_global8('gist-960-euclidean', normalize=True)
    # generate_adsampling_ivf2_global8('yahoo-minilm-384-normalized', normalize=True)
    # generate_adsampling_ivf2_global8('gooaq-distilroberta-768-normalized', normalize=True)
    # generate_adsampling_ivf2_global8('agnews-mxbai-1024-euclidean', normalize=True)
    # generate_adsampling_ivf2_global8('glove-200-angular', normalize=True)